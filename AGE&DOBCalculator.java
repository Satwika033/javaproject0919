...
public class AgeCalculater1{
    ...
    private static void calculateDOB(String ageInput, LocalDate referenceDate, 
                                   String delimiter, DateTimeFormatter formatter) {
        ...
        LocalDate dob = referenceDate.minusYears(years)
                                   .minusMonths(months)
                                   .minusDays(days);
